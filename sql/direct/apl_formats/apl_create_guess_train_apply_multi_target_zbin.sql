...
insert into CALL_SIGNATURE values (4, 'USER_APL','MODEL_ZBIN_OID_T', 'OUT');
...
insert into CALL_SIGNATURE values (1, 'USER_APL','FUNCTION_HEADER_T',  'IN');
insert into CALL_SIGNATURE values (2, 'USER_APL','MODEL_ZBIN_OID_T',    'IN');
...
insert into CALL_SIGNATURE values (6, 'USER_APL','MODEL_ZBIN_OID_T',    'OUT');
...
create table MODEL_CREATE_BIN like MODEL_ZBIN_OID_T;

drop table MODEL_TRAIN_BIN;
create table MODEL_TRAIN_BIN like MODEL_ZBIN_OID_T;
