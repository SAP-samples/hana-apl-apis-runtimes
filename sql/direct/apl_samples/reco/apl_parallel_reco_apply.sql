...
call SYS.AFLLANG_WRAPPER_PROCEDURE_CREATE('APL_AREA','PARALLEL_APPLY_RECO_MODEL','USER_APL', 'APLWRAPPER_APPLY_RECO_MODEL', APPLY_MODEL_SIGNATURE);
...
DO BEGIN     
    ...
    call APLWRAPPER_APPLY_RECO_MODEL(:header, :model, :model_nodes1, :model_nodes2, :model_links, :config, :apply_in, out_apply) WITH HINT(PARALLEL_BY_PARAMETER_PARTITIONS(p7));          
