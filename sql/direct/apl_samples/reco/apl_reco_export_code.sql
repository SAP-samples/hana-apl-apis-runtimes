...
insert into EXPORT_CONFIG values ('APL/CodeKey', '"TransactionID"'); --(use double quote to force case sensitivity if the table column name is not created in all caps)
insert into EXPORT_CONFIG values ('APL/CodeSpace', 'APL_SAMPLES.CUST_TRANSACTIONS');
