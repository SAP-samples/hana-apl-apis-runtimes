...
create type CUST_TRANSACTIONS_T as table (
	...
	"Date_PutInCaddy" LONGDATE,
	"Quantity" INTEGER,
	"TransactionID" INTEGER
);

-- KxNodes1
drop type MODEL_SOCIAL_BIPARTITE_NODES1_T;
create type MODEL_SOCIAL_BIPARTITE_NODES1_T as table (
	"node" INTEGER
);

-- KxNodes2 
drop type MODEL_SOCIAL_BIPARTITE_NODES2_T;
create type MODEL_SOCIAL_BIPARTITE_NODES2_T as table (
	"node" NVARCHAR(255) 
);

-- KxLinks
drop type MODEL_SOCIAL_BIPARTITE_LINKS_T;
create type MODEL_SOCIAL_BIPARTITE_LINKS_T as table (
	"GRAPH_NAME" NVARCHAR(255),
	"WEIGHT" DOUBLE,
	"KXNODEFIRST" INTEGER,
	"KXNODEFIRST_2" INTEGER,
	"KXNODESECOND" NVARCHAR(255),
	"KXNODESECOND_2" NVARCHAR(255)
);

-- Attributes for UserID
drop type MODEL_SOCIAL_BIPARTITE_ATTRIBUTES1_T;
create type MODEL_SOCIAL_BIPARTITE_ATTRIBUTES1_T as table (
    "GRAPH_NAME" NVARCHAR(255),
    "UserID" INTEGER,
    "generation_id" INTEGER, -- Always INTEGER
    "SOURCE_NODES" NVARCHAR(255), -- Always NVARCHAR(255)
	"HEAD_NODE_ID" INTEGER, -- Same type as UserID
	"TAIL_NODE_ID" INTEGER -- Same type as UserID
);

-- Attributes for ItemPurchased
drop type MODEL_SOCIAL_BIPARTITE_ATTRIBUTES2_T;
create type MODEL_SOCIAL_BIPARTITE_ATTRIBUTES2_T as table (
    "GRAPH_NAME" NVARCHAR(255),
    "ItemPurchased" NVARCHAR(255),
    "generation_id" INTEGER,  -- Always INTEGER
    "SOURCE_NODES" NVARCHAR(255), -- Always NVARCHAR(255)
	"HEAD_NODE_ID"  NVARCHAR(255), -- Same type as ItemPurchased
	"TAIL_NODE_ID"  NVARCHAR(255) -- Same type as ItemPurchased
);
...
create table CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE  like PROCEDURE_SIGNATURE_T;
...
insert into CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE values (7, 'USER_APL','CUST_TRANSACTIONS_T', 'IN');
insert into CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE values (8, 'USER_APL','MODEL_NATIVE_T', 'OUT');
insert into CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE values (9, 'USER_APL','MODEL_SOCIAL_BIPARTITE_NODES1_T', 'OUT');
insert into CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE values (10, 'USER_APL','MODEL_SOCIAL_BIPARTITE_NODES2_T', 'OUT');
insert into CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE values (11, 'USER_APL','MODEL_SOCIAL_BIPARTITE_LINKS_T', 'OUT');
insert into CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE values (12, 'USER_APL','MODEL_SOCIAL_COMMUNITIES_T', 'OUT');
insert into CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE values (13, 'USER_APL','MODEL_SOCIAL_BIPARTITE_ATTRIBUTES1_T', 'OUT');
insert into CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE values (14, 'USER_APL','MODEL_SOCIAL_BIPARTITE_ATTRIBUTES2_T', 'OUT');
...
call SYS.AFLLANG_WRAPPER_PROCEDURE_DROP('USER_APL','APLWRAPPER_CREATE_SOCIAL_BIPARTITE_MODEL_AND_TRAIN');
call SYS.AFLLANG_WRAPPER_PROCEDURE_CREATE('APL_AREA','CREATE_SOCIAL_MODEL_AND_TRAIN','USER_APL', 'APLWRAPPER_CREATE_SOCIAL_BIPARTITE_MODEL_AND_TRAIN', CREATE_SOCIAL_MODEL_AND_TRAIN_SIGNATURE);
...
insert into SOCIAL_CONFIG values ('APL/Graph', 'transaction','graph01');
/** Begin Common **/
insert into SOCIAL_CONFIG values ('APL/SourceNode', 'UserID','graph01');
insert into SOCIAL_CONFIG values ('APL/TargetNode', 'ItemPurchased','graph01');

insert into SOCIAL_CONFIG values ('APL/MaxConnections', '50000','graph01');
insert into SOCIAL_CONFIG values ('APL/Date', 'Date_PutInCaddy','graph01');
...
/** Begin Specifics (Transaction)**/
insert into SOCIAL_CONFIG values ('APL/Weight', '','graph01');
insert into SOCIAL_CONFIG values ('APL/Target', 'Quantity','graph01');
insert into SOCIAL_CONFIG values ('APL/TargetKey', '13','graph01');

/** End Specifics (Transaction)**/
...
-- Bipartie Projection
-- 1st projection on UserID
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','SourceGraph','graph01');
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','TargetGraph','DerivedGraph01');
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','Population','First');
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','OptimizeSpeed','true');
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','Weight','Support');
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','Directed','true');
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','TargetEventRequired','false');
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','MaxIterations','10');
insert into SOCIAL_POST_PROCESSINGS values ('BP_1', 'bipartiteprojection','MinSupport','2');

-- 2nd projection on ItemPurchased
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','SourceGraph','graph01');
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','TargetGraph','DerivedGraph02');
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','Population','Second');
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','OptimizeSpeed','true');
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','Weight','Support');
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','Directed','true');
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','TargetEventRequired','false');
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','MaxIterations','5');
insert into SOCIAL_POST_PROCESSINGS values ('BP_2', 'bipartiteprojection','MinSupport','2');


-- Communities detection on first projected graph
insert into SOCIAL_POST_PROCESSINGS values ('CM_1', 'communities','GraphName','DerivedGraph01');
...
drop table MODEL_SOCIAL_BIPARTITE_NODES1;
create table MODEL_SOCIAL_BIPARTITE_NODES1 like MODEL_SOCIAL_BIPARTITE_NODES1_T;

drop table MODEL_SOCIAL_BIPARTITE_NODES2;
create table MODEL_SOCIAL_BIPARTITE_NODES2 like MODEL_SOCIAL_BIPARTITE_NODES2_T;

drop table MODEL_SOCIAL_BIPARTITE_LINKS;
create table MODEL_SOCIAL_BIPARTITE_LINKS like MODEL_SOCIAL_BIPARTITE_LINKS_T;
...
create table MODEL_SOCIAL_ATTRIBUTES1 like MODEL_SOCIAL_BIPARTITE_ATTRIBUTES1_T;

drop table MODEL_SOCIAL_ATTRIBUTES2;
create table MODEL_SOCIAL_ATTRIBUTES2 like MODEL_SOCIAL_BIPARTITE_ATTRIBUTES2_T;
...
DO BEGIN     
    ...
    APLWRAPPER_CREATE_SOCIAL_BIPARTITE_MODEL_AND_TRAIN(
        :header,
		:config, 
		:var_desc, 
		:var_roles, 
    ...
    insert into  "USER_APL"."MODEL_SOCIAL_BIPARTITE_NODES1" select * from :out_model_nodes1;
    insert into  "USER_APL"."MODEL_SOCIAL_BIPARTITE_NODES2" select * from :out_model_nodes2;
    insert into  "USER_APL"."MODEL_SOCIAL_BIPARTITE_LINKS"  select * from :out_model_links;
    ...
    -- show result
	select * from MODEL_SOCIAL_BIPARTITE_NODES1;
	select * from MODEL_SOCIAL_BIPARTITE_NODES2;
	select * from MODEL_SOCIAL_BIPARTITE_LINKS;
