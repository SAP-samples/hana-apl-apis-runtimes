...
-- Assumption 3: There's a result dataset of apl_apply_model.sql in the ADULT01_APPLY table.
...
insert into CREATE_AND_TRAIN_CONFIG values ('APL/VariableEstimatorOf', 'rr_class;class');
...
DO BEGIN     
    ...
    insert into  "USER_APL"."MODEL_PERF_BIN" select * from :out_model;
