...
insert into FORECAST_CONFIG values ('APL/DecomposeInfluencers', 'true');
insert into FORECAST_CONFIG values ('APL/ApplyExtraMode', 'First Forecast with Stable Components and Residues and Error Bars');
