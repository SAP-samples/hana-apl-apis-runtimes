...
insert into CREATE_AND_TRAIN_CONFIG values ('APL/CalculateSQLExpressions', 'false');
insert into CREATE_AND_TRAIN_CONFIG values ('APL/Distance', 'L1');
insert into CREATE_AND_TRAIN_CONFIG values ('APL/EncodingStrategy', 'TargetMean');
insert into CREATE_AND_TRAIN_CONFIG values ('APL/CalculateCrossStatistics', 'enabled');
