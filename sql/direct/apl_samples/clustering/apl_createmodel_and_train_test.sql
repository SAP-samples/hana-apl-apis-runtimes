...
create table CLUST_TEST_MODEL_BIN like MODEL_BIN_OID_T;
...
DO BEGIN     
    ...
    insert into  "USER_APL"."INDICATORS"      select * from :out_indic;
   	...
   	APLWRAPPER_TEST_MODEL(:header, :out_model, :test_config, :dataset, out_test_model, out_test_log, out_test_indic);
	...
	select * from "USER_APL"."CLUST_TEST_MODEL_BIN";
