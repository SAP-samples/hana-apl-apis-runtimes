...
DO BEGIN     
    ...
    APLWRAPPER_APPLY_MODEL_AND_TEST(:header, :model_in, :apply_config,  :dataset, out_apply , model_test,out_apply_log, out_indic);

    -- store result into table
    insert into  "USER_APL"."ADULT01_APPLY_TEST"        select * from :out_apply;
