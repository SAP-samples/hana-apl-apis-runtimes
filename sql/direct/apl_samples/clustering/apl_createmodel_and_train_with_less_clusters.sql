...
-- insert into CREATE_AND_TRAIN_CONFIG values ('APL/NbClusters', '5');
insert into CREATE_AND_TRAIN_CONFIG values ('APL/NbClustersMin', '3');
insert into CREATE_AND_TRAIN_CONFIG values ('APL/NbClustersMax', '8');
