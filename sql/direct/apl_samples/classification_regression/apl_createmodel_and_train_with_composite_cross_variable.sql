...
insert into VARIABLE_ROLES_WITH_COMPOSITES values ('mycomposite', 'input', 'cross1', 'sex');
insert into VARIABLE_ROLES_WITH_COMPOSITES values ('mycomposite', 'input', 'cross2', 'age');
insert into VARIABLE_ROLES_WITH_COMPOSITES values ('mycomposite', 'input', 'cross3', 'workclass');
insert into VARIABLE_ROLES_WITH_COMPOSITES values ('fnlwgt', 'target', null, null);
insert into VARIABLE_ROLES_WITH_COMPOSITES values ('class', 'skip', null, null);
...
DO BEGIN     
	...
	select * from "USER_APL"."INDICATORS"  where VARIABLE = 'mycomposite';
END;
