...
insert into RETRAIN_MODEL_SIGNATURE values (5, 'USER_APL','MODEL_BIN_OID_T', 'OUT');
insert into RETRAIN_MODEL_SIGNATURE values (6, 'USER_APL','OPERATION_LOG_T', 'OUT');
...
DO BEGIN     
    ...
    APLWRAPPER_RETRAIN_MODEL(:header, :model_in, :train_config, :dataset, out_train_model, out_train_log, out_sum, out_indic);
