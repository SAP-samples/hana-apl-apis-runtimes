...
insert into APPLY_MODEL_SIGNATURE values (7, 'USER_APL','SUMMARY_T', 'OUT');
...
DO BEGIN     
    ...
    APLWRAPPER_APPLY_MODEL(:header, :model_in, :apply_config,  :dataset, out_apply , out_apply_log, out_summ);
