...
-- A composite variable is also defined and used.
--
...
drop type GOWALLA_DEMO_T;
create type GOWALLA_DEMO_T as table (
	"user" INTEGER,
	"checkInTime" NVARCHAR(19),
	"latitude" DOUBLE,
	"longitude" DOUBLE,
	"locationId" INTEGER,
	"isTourist" INTEGER,
...
insert into CREATE_MODEL_AND_TRAIN_SIGNATURE values (4, 'USER_APL','VARIABLE_ROLES_WITH_COMPOSITES_T', 'IN');
insert into CREATE_MODEL_AND_TRAIN_SIGNATURE values (5, 'USER_APL','GOWALLA_DEMO_T', 'IN');
...
insert into VARIABLE_DESC values (0, 'user', 'integer', 'nominal', 1, 0, NULL, NULL, '');
insert into VARIABLE_DESC values (1, 'checkInTime', 'datetime', 'continuous', 1, 0, NULL, NULL, '');
insert into VARIABLE_DESC values (2, 'latitude', 'angle', 'continuous', 0, 0, NULL, NULL, '');
insert into VARIABLE_DESC values (3, 'longitude', 'angle', 'continuous', 0, 0, NULL, NULL, '');
insert into VARIABLE_DESC values (4, 'locationId', 'integer','nominal', 0, 0, NULL, NULL, '');
insert into VARIABLE_DESC values (5, 'isTourist', 'integer','nominal', 0, 0, NULL, NULL, '');
insert into VARIABLE_DESC values (6, 'isMustSee', 'integer','nominal', 0, 0, NULL, NULL, '');

-- let this table empty to use guess variables

drop table VARIABLE_ROLES_WITH_COMPOSITES;
create table VARIABLE_ROLES_WITH_COMPOSITES like VARIABLE_ROLES_WITH_COMPOSITES_T;
insert into VARIABLE_ROLES_WITH_COMPOSITES values ('position', 'input', 'latitude', 'latitude');
insert into VARIABLE_ROLES_WITH_COMPOSITES values ('position', 'input', 'longitude', 'longitude');

select * from VARIABLE_ROLES_WITH_COMPOSITES;
...
DO BEGIN     
    ...
    var_role = select * from VARIABLE_ROLES_WITH_COMPOSITES;  
    dataset  = select * from APL_SAMPLES.GOWALLA_DEMO;  
	...
	select * from "USER_APL"."INDICATORS"  where VARIABLE = 'position';
END;
