...
create table CREATE_MODEL_SIGNATURE  like PROCEDURE_SIGNATURE_T;
...
insert into CREATE_MODEL_SIGNATURE values (4, 'USER_APL','MODEL_NATIVE_T', 'OUT');
...
drop table MODEL_NATIVE;
create table MODEL_NATIVE like MODEL_NATIVE_T;
...
DO BEGIN     
    ...
    insert into  "USER_APL"."MODEL_NATIVE"          select * from :out_model;
    insert into  "USER_APL"."VARIABLE_DESC_OUT"  select * from :out_var_desc;

	-- show result
	select * from "USER_APL"."MODEL_NATIVE";
