...
insert into CREATE_MODEL_AND_TRAIN_SIGNATURE values (9, 'USER_APL','DEBRIEF_METRIC_OID_T', 'OUT');
insert into CREATE_MODEL_AND_TRAIN_SIGNATURE values (10, 'USER_APL','DEBRIEF_PROPERTY_OID_T', 'OUT');
...
DO BEGIN     
    ...
    APLWRAPPER_CREATE_MODEL_AND_TRAIN(:header, :config, :var_desc,:var_role, :dataset, out_model,  out_log, out_sum, out_debrief_metric, out_debrief_property);          
