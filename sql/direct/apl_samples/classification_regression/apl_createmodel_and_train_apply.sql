...
drop table CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE;
create table CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE  like PROCEDURE_SIGNATURE_T;

insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (1, 'USER_APL','FUNCTION_HEADER_T', 'IN');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (2, 'USER_APL','OPERATION_CONFIG_T', 'IN');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (3, 'USER_APL','VARIABLE_DESC_T', 'IN');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (4, 'USER_APL','VARIABLE_ROLES_T', 'IN');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (5, 'USER_APL','ADULT01_T', 'IN');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (6, 'USER_APL','ADULT01_T', 'IN');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (7, 'USER_APL','ADULT01_T_OUT',      'OUT');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (8, 'USER_APL','MODEL_BIN_OID_T', 'OUT');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (9, 'USER_APL','OPERATION_LOG_T', 'OUT');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (10, 'USER_APL','SUMMARY_T', 'OUT');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (11, 'USER_APL','DEBRIEF_METRIC_OID_T', 'OUT');
insert into CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE values (12, 'USER_APL','DEBRIEF_PROPERTY_OID_T', 'OUT');

call SYS.AFLLANG_WRAPPER_PROCEDURE_DROP('USER_APL','APLWRAPPER_CREATE_MODEL_AND_TRAIN_APPLY');
call SYS.AFLLANG_WRAPPER_PROCEDURE_CREATE('APL_AREA','CREATE_MODEL_AND_TRAIN_APPLY','USER_APL', 'APLWRAPPER_CREATE_MODEL_AND_TRAIN_APPLY', CREATE_MODEL_AND_TRAIN_APPLY_SIGNATURE);
...
DO BEGIN     
    ...
    training = select * from APL_SAMPLES.ADULT01 LIMIT 10000;
    applyin  = select * from APL_SAMPLES.ADULT01 LIMIT 20000 OFFSET 10000;  

    APLWRAPPER_CREATE_MODEL_AND_TRAIN_APPLY(:header, :config, :var_desc,:var_role, :training, :applyin, out_apply, out_model,  out_log, out_sum, out_debrief_metric, out_debrief_property);          
