...
--               For instance, you have used apl_createmodel_and_train_custom_cutting.sql before
--  @depend(apl_createmodel_and_train_custom_cutting.sql)
...
insert into RETRAIN_MODEL_SIGNATURE values (3, 'USER_APL','OPERATION_CONFIG_T', 'IN');
...
insert into RETRAIN_MODEL_SIGNATURE values (7, 'USER_APL','MODEL_BIN_OID_T', 'OUT');
insert into RETRAIN_MODEL_SIGNATURE values (8, 'USER_APL','OPERATION_LOG_T', 'OUT');
insert into RETRAIN_MODEL_SIGNATURE values (9, 'USER_APL','SUMMARY_T', 'OUT');
insert into RETRAIN_MODEL_SIGNATURE values (10, 'USER_APL','INDICATORS_T', 'OUT');

call SYS.AFLLANG_WRAPPER_PROCEDURE_DROP('USER_APL','APLWRAPPER_RETRAIN_MODEL');
call SYS.AFLLANG_WRAPPER_PROCEDURE_CREATE('APL_AREA','RETRAIN_MODEL','USER_APL', 'APLWRAPPER_RETRAIN_MODEL', RETRAIN_MODEL_SIGNATURE);
...
DO BEGIN     
    ...
    APLWRAPPER_RETRAIN_MODEL(:header, :model_in, :train_config, :estimation,:validation,:test, out_train_model, out_train_log, out_sum, out_indic);
