...
insert into APPLY_CONFIG values ('APL/ApplyProbability', 'true');
insert into APPLY_CONFIG values ('APL/ApplyPredictedQuantile', '100');
insert into APPLY_CONFIG values ('APL/ApplyPredictedAscendingQuantile', '100');
