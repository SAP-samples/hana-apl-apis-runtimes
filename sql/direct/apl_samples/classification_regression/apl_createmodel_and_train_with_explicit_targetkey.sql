...
-- This script creates a model, guesses the variable descriptions, and trains it.
-- The target key is explicitly set, using the extended version of the operation configuration OPERATION_CONFIG_DETAILED_T, with key, context, and value.
-- 
...
insert into CREATE_MODEL_AND_TRAIN_SIGNATURE values (2, 'USER_APL','OPERATION_CONFIG_DETAILED_T', 'IN');
...
create table CREATE_AND_TRAIN_CONFIG like OPERATION_CONFIG_DETAILED_T;
...
insert into CREATE_AND_TRAIN_CONFIG values ('APL/TargetKey', '0', 'class');
