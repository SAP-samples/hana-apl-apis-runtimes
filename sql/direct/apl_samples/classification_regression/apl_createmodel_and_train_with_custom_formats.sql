-- ================================================================
-- APL_AREA, CREATE_MODEL_AND_TRAIN, using a text format for the model
-- This script creates a model, guesses its description and trains it. 
-- The training dataset is used through a 'random with no test' cutting strategy.
-- The precision and date format are customized.
--
...
insert into CREATE_MODEL_AND_TRAIN_SIGNATURE values (6, 'USER_APL','MODEL_TXT_OID_T', 'OUT');
...
insert into FUNC_HEADER values ('Language', 'fr');
insert into FUNC_HEADER values ('DateFormat', 'DMY:/');
insert into FUNC_HEADER values ('Precision', '2');
insert into FUNC_HEADER values ('DecimalSymbol', '1');
...
DO BEGIN     
    ...
    insert into  "USER_APL"."MODEL_TRAIN_TXT" select * from :out_model;
