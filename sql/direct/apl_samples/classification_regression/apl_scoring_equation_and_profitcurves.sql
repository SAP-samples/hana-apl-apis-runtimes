...
insert into SCORING_EQUATION_SIGNATURE values (10, 'USER_APL','PROFITCURVE_T', 'OUT');
...
DO BEGIN     
    ...
    APLWRAPPER_SCORING_EQUATION(:header, :config, :var_desc, :var_role, :dataset,  out_log, out_sum, out_indic, out_equation, out_curves);
