...
insert into TRAIN_MODEL_SIGNATURE values (6, 'USER_APL','MODEL_BIN_OID_T', 'OUT');
insert into TRAIN_MODEL_SIGNATURE values (7, 'USER_APL','OPERATION_LOG_T', 'OUT');
...
insert into VARIABLE_ROLES values ('age', 'skip');
insert into VARIABLE_ROLES values ('workclass', 'skip');
insert into VARIABLE_ROLES values ('marital-status', 'skip');
insert into VARIABLE_ROLES values ('relationship', 'skip');
...
DO BEGIN     
    ...
    APLWRAPPER_TRAIN_MODEL(:header, :model_in, :train_config, :var_role, :dataset, out_train_model, out_train_log, out_sum, out_indic);
