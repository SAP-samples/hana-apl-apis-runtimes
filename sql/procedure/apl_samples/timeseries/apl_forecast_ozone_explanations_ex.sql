...
-- Case #3: forecasted value + confidence interval + signal decomposition
-- --------------------------------------------------------------------------
...
insert into FORECAST_CONFIG values ('APL/DecomposeInfluencers', 'true',null);
insert into FORECAST_CONFIG values ('APL/ApplyExtraMode', 'First Forecast with Stable Components and Residues and Error Bars',null);
