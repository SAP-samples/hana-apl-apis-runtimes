...
create table "CASHFLOWS_SEG" as (select *, 1 as "Seg" from "APL_SAMPLES"."CASHFLOWS_FULL");
insert into "CASHFLOWS_SEG" select  *,2 as "Seg" from "APL_SAMPLES"."CASHFLOWS_FULL";
insert into "CASHFLOWS_SEG" select  *,3 as "Seg" from "APL_SAMPLES"."CASHFLOWS_FULL";
insert into "CASHFLOWS_SEG" select  *,4 as "Seg" from "APL_SAMPLES"."CASHFLOWS_FULL";
