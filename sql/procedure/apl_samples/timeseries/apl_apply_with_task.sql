...
create COLUMN table TRAINING_CONFIG like "SAP_PA_APL"."sap.pa.apl.base::BASE.T.OPERATION_CONFIG_EXTENDED";
insert into TRAINING_CONFIG values ('APL/ModelType', 'timeseries',null);

insert into TRAINING_CONFIG values ('APL/Horizon', '20',null);
insert into TRAINING_CONFIG values ('APL/TimePointColumnName', 'Date',null);
insert into TRAINING_CONFIG values ('APL/LastTrainingTimePoint', '2001-12-29 00:00:00',null);
insert into TRAINING_CONFIG values ('APL/WithExtraPredictable', 'false',null);
insert into TRAINING_CONFIG values ('APL/ForcePositiveForecast', 'true',null);
...
create table CASHFLOWS_DESC like "SAP_PA_APL"."sap.pa.apl.base::BASE.T.VARIABLE_DESC_OID";
insert into CASHFLOWS_DESC  select *,'42' from APL_SAMPLES.CASHFLOWS_DESC;

drop table APPLY_CONFIG;
create COLUMN table APPLY_CONFIG like "SAP_PA_APL"."sap.pa.apl.base::BASE.T.OPERATION_CONFIG_EXTENDED";
--insert into APPLY_CONFIG values ('APL/ApplyLastTimePoint', '2001-12-29 00:00:00',null);
...
DO BEGIN     
    ...
    config   = select * from TRAINING_CONFIG;            
