...
select * from APL_SAMPLES.CENSUS where "class" = 1 order by "id";

drop view DATASET_2;
create view DATASET_2 as   
select * from APL_SAMPLES.CENSUS where "class" = 0 order by "id";
...
DO BEGIN
    ...
    :header.insert(('Oid', 'Supervised Clustering Mdl'));
