...
insert into CREATE_AND_TRAIN_CONFIG values ('APL/Distance', 'L1',null);
insert into CREATE_AND_TRAIN_CONFIG values ('APL/EncodingStrategy', 'TargetMean',null);
insert into CREATE_AND_TRAIN_CONFIG values ('APL/CalculateCrossStatistics', 'enabled',null);
