...
SELECT  "native-country","class", "sex", "race",  "workclass", "education", "marital-status", "occupation", "relationship" , "age","hours-per-week",  "capital-loss","capital-gain", "fnlwgt", "education-num" FROM APL_SAMPLES.ADULT01 );
commit;
