...
DO BEGIN     
    ...
    "SAP_PA_APL"."sap.pa.apl.base::TRAIN_MODEL"(:header, :model_in, :train_config, :var_role, 'APL_SAMPLES','ADULT01', out_train_model, out_train_log, out_sum, out_indic);
