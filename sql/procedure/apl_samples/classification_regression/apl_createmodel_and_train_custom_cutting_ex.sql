...
DO BEGIN     
    ...
    "SAP_PA_APL"."sap.pa.apl.base::CREATE_MODEL_AND_TRAIN_MULTI_DATASET"(:header, :config, :var_desc,:var_role, 'USER_APL','ESTIMATION', 'USER_APL','VALIDATION', 'USER_APL','TEST',out_model,out_log,out_sum,out_indic);          
