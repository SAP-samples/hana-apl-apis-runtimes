...
DO BEGIN     
    ...
    "SAP_PA_APL"."sap.pa.apl.base::KEY_INFLUENCERS"(:header, :config, :var_desc,  :var_role,'APL_SAMPLES','ADULT01', out_log, out_sum,out_indic,out_influencer, out_continous_groups, out_other_groups);
