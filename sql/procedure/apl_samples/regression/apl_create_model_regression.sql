...
-- Boosting model for a regression task
...
insert into VARIABLE_ROLES values ('age', 'target', null, null, null);
insert into VARIABLE_ROLES values ('fnlwgt', 'skip', null, null, null);
...
insert into CREATE_AND_TRAIN_CONFIG values ('APL/ModelType', 'regression',null);

insert into CREATE_AND_TRAIN_CONFIG values ('APL/MaxIterations', '200',null);
insert into CREATE_AND_TRAIN_CONFIG values ('APL/MaxDepth', '4',null);
insert into CREATE_AND_TRAIN_CONFIG values ('APL/EarlyStoppingPatience', '20',null);
insert into CREATE_AND_TRAIN_CONFIG values ('APL/EvalMetric', 'RMSE',null);
...
DO BEGIN     
    ...
    -- perf indicators
    select * from "USER_APL"."INDICATORS" where "VARIABLE"='gb_score_age';
