...
--               For instance, you have used apl_create_similar_item_reco_model_and_train_ex.sql before
--  @depend(apl_create_similar_item_reco_model_and_train_ex.sql)
...
insert into EXPORT_CONFIG values ('APL/RecommendationType', 'similarity',null);  -- optional (default: standard)
insert into EXPORT_CONFIG values ('APL/RecommendProcName', 'RECOMMEND_SIMILAR_FILM',null);  -- optional (default: RECOMMEND_SIMILAR_ITEM)
insert into EXPORT_CONFIG values ('APL/RecoLinksTable', 'MODEL_LINKS',null);  -- optional (default: KxLinks1)
