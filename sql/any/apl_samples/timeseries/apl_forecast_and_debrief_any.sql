...
-- --------------------------------------------------------------------------
call "_SYS_AFL"."APL_FORECAST__OVERLOAD_5_6"(FUNC_HEADER, FORECAST_CONFIG, VARIABLE_DESC, VARIABLE_ROLES, USER_APL.CASHFLOWS_SORTED, USER_APL.FORECAST_OUT, OPERATION_LOG, SUMMARY, INDICATORS, DEBRIEF_METRIC, DEBRIEF_PROPERTY) with overview;
