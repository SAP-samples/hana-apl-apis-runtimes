...
create table ADULT01_SEG as (select *, 1 as "Seg" from "APL_SAMPLES"."ANY_ADULT01");
...
as BEGIN 
    ...
    insert into "ADULT01_SEG" select  *,  -1 as "Seg" from "APL_SAMPLES"."ANY_ADULT01"  limit 1;
   
   	-- insert n segments 
	for i in 1..:nb_seg do 
       insert into "ADULT01_SEG" select  *,  :i as "Seg" from "APL_SAMPLES"."ANY_ADULT01";
	end for;
END;
...
DO BEGIN
    ...
    "_SYS_AFL"."APL_CREATE_MODEL_AND_TRAIN__OVERLOAD_5_5"(:header, :config, :var_desc,:var_role, :datatset,out_model,out_log,out_sum,out_debrief_metric,out_debrief_property);
